...
public interface EntitiesPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute '{@link org.example.entities.entities.AttributeType#getLenght <em>Lenght</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Lenght</em>'.
   * @see org.example.entities.entities.AttributeType#getLenght()
   * @see #getAttributeType()
   * @generated
   */
  EAttribute getAttributeType_Lenght();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute ATTRIBUTE_TYPE__LENGHT = eINSTANCE.getAttributeType_Lenght();
