 ...
 *   <li>{@link org.example.entities.entities.AttributeType#getLenght <em>Lenght</em>}</li>
 * </ul>
 * </p>
 *
...
public interface AttributeType extends EObject
{
   ...
   * @see #setLenght(int)
   * @see org.example.entities.entities.EntitiesPackage#getAttributeType_Lenght()
   * @model
   * @generated
   */
  int getLenght();
  ...
  /**
   * Sets the value of the '{@link org.example.entities.entities.AttributeType#getLenght <em>Lenght</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
